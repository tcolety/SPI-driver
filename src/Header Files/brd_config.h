...
#define LEUART_TX_ROUTE         LEUART_ROUTELOC0_TXLOC_LOC27

#define LEUART_RX_PORT          gpioPortF
#define LEUART_RX_PIN           4
#define LEUART_RX_ROUTE         LEUART_ROUTELOC0_RXLOC_LOC27
...
//LEUART TX/RX PINS
#define USART_ICM_EN_PORT      gpioPortF
#define USART_ICM_EN_PIN       8

#define USART_TX_PORT          gpioPortC
#define USART_TX_PIN           0
#define USART_TX_ROUTE         USART_ROUTELOC0_TXLOC_LOC18

#define USART_RX_PORT          gpioPortC
#define USART_RX_PIN           1
#define USART_RX_ROUTE         USART_ROUTELOC0_RXLOC_LOC18

#define USART_CS_PORT          gpioPortC
#define USART_CS_PIN           3
#define USART_CS_ROUTE         USART_ROUTELOC0_CSLOC_LOC18

#define USART_SCLK_PORT        gpioPortC
#define USART_SCLK_PIN         2
#define USART_SCLK_ROUTE       USART_ROUTELOC0_CLKLOC_LOC18

//ICM20648
#define ICM_USART             USART3
#define ICM_ENABLE            usartEnable
#define ICM_REFFREQ           0 //SETS TO DEFAULT
#define ICM_BAUDRATE          2000000
...
#define ICM_PRSRXCH           USART_TRIGCTRL_TSEL_PRSCH0 //NOT USED
#define ICM_AUTOTX            false
#define ICM_AUTOCSENABLE      false
#define ICM_AUTOCSHOLD        2
#define ICM_AUTOCSSETUP       2
